	...
	public function upload()
	{
		...
		switch ($action) {
			...
			case 'uploadscrawl':
				...
				/* 上传视频 */
			case 'uploadvideo':
				$result = $this->_ueditor_upload(array('maxSize' => 10737418240,/*1G*/'exts'=>array('mp4', 'avi', 'wmv','rm','rmvb','mkv','mp3')));
				break;
				/* 上传文件 */
			case 'uploadfile':
				$result = $this->_ueditor_upload(array('exts'=>array('jpg', 'gif', 'png', 'jpeg','txt','pdf','doc','docx','xls','xlsx','zip','rar','ppt','pptx','mp3',)));
				break;
