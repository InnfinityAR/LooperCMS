<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/wechat\view\we\mats_list.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/wechat\view\we\ajax_mats_list.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		<div class="row maintop">
			<div class="col-xs-12">
				<a class="red" href="<?php echo url('wechat/We/mats_add'); ?>">
					<button class="btn btn-xs btn-danger">
						<i class="ace-icon fa fa-plus bigger-110"></i>
						上传永久素材
					</button>
				</a>
				<a class="red confirm-rst-url-btn" href="<?php echo url('wechat/We/mats_get'); ?>" data-info="请勿频繁同步,确认要同步?">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form class="ajaxForm2" name="leftnav" method="post" action="<?php echo url('wechat/We/mats_alldel'); ?>" >
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody id="ajax-data">
								<?php if(is_array($mats_list) || $mats_list instanceof \think\Collection || $mats_list instanceof \think\Paginator): if( count($mats_list)==0 ) : echo "" ;else: foreach($mats_list as $key=>$v): ?>
	<tr>
		<td class="hidden-xs" align="center">
			<label class="pos-rel">
				<input name='mats_id_id[]' id="navid" class="ace"  type='checkbox' value='<?php echo $v['mats_id']; ?>'>
				<span class="lbl"></span>
			</label>
		</td>
		<td>
			<?php if(in_array($v['mats_type'],['news','image','video'])): ?>
		...
		<td><?php echo $v['mats_id']; ?></td>
		<td><?php echo $v['mats_name']; ?></td>
		<td><?php echo $v['mats_type']; ?></td>
		<td><?php echo $v['media_id']; ?></td>
		<td><?php if($v['mats_type'] == 'news'): ?><?php echo $v['news_index']; endif; ?></td>
		<td class="hidden-sm hidden-xs"><?php echo date('Y-m-d',$v['create_time']); ?></td>
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<?php if($v['mats_type'] == 'news'): ?>
				<a class="green" href="<?php echo url('wechat/We/mats_edit',['mats_id'=>$v['mats_id']]); ?>" data-toggle="tooltip" title="修改">
					<i class="ace-icon fa fa-pencil bigger-130"></i>
				</a>
				<?php endif; ?>
				<a class="red confirm-rst-url-btn" href="<?php echo url('wechat/We/mats_del',array('mats_id'=>$v['mats_id'])); ?>" data-info="您确定要删除吗？" data-toggle="tooltip" title="删除">
			...
			<div class="hidden-md hidden-lg">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<?php if($v['mats_type'] == 'news'): ?>
						<li>
							<a href="<?php echo url('wechat/We/mats_edit',['mats_id'=>$v['mats_id']]); ?>" class="tooltip-success" data-rel="tooltip" title="修改" data-original-title="修改">
										<span class="green">
						...
						<?php endif; ?>
						<li>
							<a href="<?php echo url('wechat/We/mats_del',array('mats_id'=>$v['mats_id'])); ?>"  data-info="您确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="删除" data-original-title="删除">
							<span class="red">
	...
	<tr class="detail-row">
		<td colspan="10">
			<div class="row">
				<?php switch($v['mats_type']): case "news": ?>
				<label class="form-label col-xs-1 text-right">图文内容：</label>
				<div class="formControls col-xs-11">
					<textarea  name="" readonly="readonly" cols="" rows="8" class="col-xs-12"   id="form-field-9"  maxlength=""><?php echo var_export(json_decode($v['news_content'],true)); ?></textarea>
				</div>
				<?php break; case "video": ?>
				<label class="form-label col-xs-1 text-right">视频简介：</label>
				<div class="formControls col-xs-11">
					<textarea  name="" readonly="readonly" cols="" rows="4" class="col-xs-12"   id="form-field-9"  maxlength=""><?php echo var_export(json_decode($v['video_content'],true)); ?></textarea>
				</div>
				<?php break; default: ?>
				<label class="form-label col-xs-1 text-right">图片地址：</label>
				<div class="formControls col-xs-11"><?php echo $v['url']; ?></div>
				<?php endswitch; ?>
			</div>
		</td>
	</tr>
