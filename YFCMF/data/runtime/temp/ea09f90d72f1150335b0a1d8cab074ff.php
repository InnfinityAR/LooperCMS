<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"E:\wamp\www\YFCMF/app/admin\view\flag\flag_edit.html";i:1492247686;s:49:"E:\wamp\www\YFCMF/app/admin\view\public\base.html";i:1489327653;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\header.html";i:1492401034;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\footer.html";i:1492400493;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('admin/Flag/flag_runedit'); ?>"  enctype="multipart/form-data">
					<input type="hidden" name="diyflag_id" id="n_id" value="<?php echo $diyflag_list['diyflag_id']; ?>" />
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 风格名称：  </label>
						<div class="col-sm-10">
							<input type="text" name="news_title" id="news_title"  value="<?php echo $diyflag_list['diyflag_name']; ?>"   class="col-xs-10 col-sm-6" required/>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="hidden" name="checkpic" id="checkpic1" value="<?php echo $diyflag_list['diyflag_img']; ?>" />
							<input type="hidden" name="oldcheckpic" id="oldcheckpic1" value="<?php echo $diyflag_list['diyflag_img']; ?>" />
							<a href="javascript:;" class="file" title="点击选择所要上传的图片">
								<input type="file" name="pic_two" id="file1" multiple="multiple"/>
								选择上传文件
							</a>
							<span class="lbl">&nbsp;&nbsp;<img src="<?php echo get_imgurl($diyflag_list['diyflag_img']); ?>" width="100" height="70" id="img1" ></span>&nbsp;&nbsp;
							<a href="javascript:;" onclick="return backpic1('<?php echo get_imgurl($diyflag_list['diyflag_img']); ?>');" title="还原修改前的图片" class="file">
								撤销修改
							</a>
							<span class="lbl">&nbsp;&nbsp;第一张图片<br /></span>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 封面图片上传： </label>
						<div class="col-sm-10">
							<input type="hidden" name="checkpic" id="checkpic" value="<?php echo $diyflag_list['diyflag_newimg']; ?>" />
							<input type="hidden" name="oldcheckpic" id="oldcheckpic" value="<?php echo $diyflag_list['diyflag_newimg']; ?>" />
							<a href="javascript:;" class="file" title="点击选择所要上传的图片">
								<input type="file" name="pic_one" id="file0" multiple="multiple"/>
								选择上传文件
							</a>
							<span class="lbl">&nbsp;&nbsp;<img src="<?php echo get_imgurl($diyflag_list['diyflag_newimg']); ?>" width="100" height="70" id="img0" ></span>&nbsp;&nbsp;
							<a href="javascript:;" onclick="return backpic('<?php echo get_imgurl($diyflag_list['diyflag_newimg']); ?>');" title="还原修改前的图片" class="file">
								撤销修改
							</a>
							<span class="lbl">&nbsp;&nbsp;点击过后的图片<br /></span>
						</div>
					</div>
					<div class="space-4"></div>
