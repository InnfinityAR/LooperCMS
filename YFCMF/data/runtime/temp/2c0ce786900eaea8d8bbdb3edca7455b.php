<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\addons\addons_list.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form class="ajaxForm" name="addons_order" method="post" action="<?php echo url('admin/Addons/addons_order'); ?>" >
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): if( count($addons)==0 ) : echo "" ;else: foreach($addons as $key=>$v): ?>
								<tr>
									<?php if(!(empty($v['id']) || (($v['id'] instanceof \think\Collection || $v['id'] instanceof \think\Paginator ) && $v['id']->isEmpty()))): ?>
									<td height="28" ><?php echo $v['id']; ?></td>
									<td><input name="<?php echo $v['id']; ?>" value="<?php echo $v['sort']; ?>" class="list_order center"/></td>
									<?php else: ?>
									<td height="28" ></td>
									<td></td>
									<?php endif; ?>
