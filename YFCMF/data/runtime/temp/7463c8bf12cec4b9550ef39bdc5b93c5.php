<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"E:\wamp\www\YFCMF/app/admin\view\news\news_add.html";i:1492401799;s:49:"E:\wamp\www\YFCMF/app/admin\view\public\base.html";i:1489327653;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\header.html";i:1492401034;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\footer.html";i:1492400493;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('admin/News/news_runadd'); ?>"  enctype="multipart/form-data">
				<!--//所属栏目改为所属专辑-->
							...
							<div style="height:44px; overflow-y: scroll;" id="auto_flag">
								<?php if(is_array($diyflag) || $diyflag instanceof \think\Collection || $diyflag instanceof \think\Paginator): if( count($diyflag)==0 ) : echo "" ;else: foreach($diyflag as $key=>$diyflag): ?>
									<label id="news_flag_<?php echo $diyflag['diyflag_name']; ?>">
										<input class="ace ace-checkbox-2" name="news_flag[]" type="checkbox" id="news_flag_va<?php echo $diyflag['diyflag_name']; ?>" value="<?php echo $diyflag['diyflag_name']; ?>" />
										<span class="lbl"> <?php echo $diyflag['diyflag_name']; ?></span>
									</label>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
							<span class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="float: right; overflow:hidden; ">
								自定义风格
							</span>
							<!-- 模态框（Modal） -->
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<input type="text" name="self_flag" id="self_flag" placeholder="EDM" style="margin: 0px; padding: 0px;">
										</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="news_key" id="news_key" placeholder="输入Loop关键字，以英文,逗号隔开" class="col-xs-10 col-sm-6" />
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
				...
				<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 从本地选择音乐:</label>
					...
					<div class="form-group" >
						<div class="col-sm-10">
							<div id="test22" width="500px" style="margin-left: 200px;overflow: auto;">
							</div>
						</div>
					</div>
					<div class="form-group">
