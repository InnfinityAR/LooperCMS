<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/wechat\view\we\wesys.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="wesys" method="post" action="<?php echo url('wechat/We/runwesys'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 公众号名称： </label>
						<div class="col-sm-9">
							<input type="text" name="we_options[we_name]" id="we_name" value="<?php echo $sys['we_name']; ?>"  placeholder="请输入公众号名称"  class="col-xs-10 col-sm-5" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="we_options[we_id]" id="we_id" value="<?php echo $sys['we_id']; ?>" placeholder="请输入公众号原始id"   class="col-xs-10 col-sm-5" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填</span>
							<span class="help-inline col-xs-12 col-sm-7">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="we_options[we_number]" id="we_number" value="<?php echo $sys['we_number']; ?>"  placeholder="请输入微信号"  class="col-xs-10 col-sm-5" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填</span>
							<span class="help-inline col-xs-12 col-sm-7">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="we_options[app_id]" id="app_id" value="<?php echo $sys['app_id']; ?>" placeholder="请输入AppID（公众号）"   class="col-xs-10 col-sm-5" required/>
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resthr"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="we_options[secret]" id="secret" value="<?php echo $sys['secret']; ?>"  placeholder="请输入AppSecret（公众号）"  class="col-xs-10 col-sm-5" required/>
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resthr"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="we_options[token]" id="token" value="<?php echo $sys['token']; ?>"  placeholder="请输入Token（公众号）"  class="col-xs-10 col-sm-5"/>
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resthr"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="we_options[aes_key]" value="<?php echo $sys['aes_key']; ?>"  placeholder="请输入EncodingAESKey（公众号）"  class="col-xs-10 col-sm-5"/>
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resthr"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="we_options[we_type]"  class="col-sm-4" required>
								...
								<option value="1" <?php if($sys['we_type'] == 1): ?>selected<?php endif; ?>>普通订阅号</option>
								<option value="2" <?php if($sys['we_type'] == 2): ?>selected<?php endif; ?>>普通服务号</option>
								<option value="3" <?php if($sys['we_type'] == 3): ?>selected<?php endif; ?>>认证订阅号</option>
								<option value="4" <?php if($sys['we_type'] == 4): ?>selected<?php endif; ?>>认证服务号</option>
							</select>
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resthr"></span>
							</span>
