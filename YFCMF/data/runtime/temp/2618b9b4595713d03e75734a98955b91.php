<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/install\view\\step3.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/install\view\public\head.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/install\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/install\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<body>
	...
	<div class="version"><?php echo \think\Config::get('yfcmf_version'); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="<?php echo url('install/Index/step4'); ?>" method="post">
				...
				<div class="server">
					<table width="100%">
						...
						<tr>
							...
							<td><input type="text" name="dbname" id="dbname" value="yfcmf" class="input"></td>
							<td><div id="js-install-tip-dbname"></div></td>
						</tr>
						<tr>
							<td class="text-left">数据库表前缀：</td>
							<td><input type="text" name="dbprefix" id="dbprefix" value="yf_" class="input"></td>
							<td>
								<div id="js-install-tip-dbprefix">
									<span class="gray">建议使用默认，同一数据库安装多个YFCMF时需修改</span>
								</div>
							</td>
						</tr>
					</table>
					<table width="100%">
						...
						<tr>
							...
							<td><input type="text" name="sitename" value="YFCMF内容管理框架" class="input"></td>
							<td><div id="js-install-tip-sitename"></div></td>
						</tr>
						<tr>
							<td class="text-left">网站域名：</td>
							<td><input type="text" name="siteurl" value="<?php echo get_host(); ?>/" class="input" autoComplete="off"></td>
							<td>
						...
						<tr>
							...
							<td><input type="text" name="sitekeywords" value="YFCMF,php,内容管理框架,cmf,cms,雨飞工作室" class="input" autoComplete="off"></td>
							<td><div id="js-install-tip-sitekeywords"></div></td>
						</tr>
						<tr>
							<td class="text-left">描述：</td>
							<td><input type="text" name="siteinfo" class="input" value="YFCMF是雨飞工作室发布的一款用于快速开发的内容管理框架"></td>
				...
				<div class="bottom text-center">
					<a href="<?php echo url('install/Index/step2'); ?>" class="btn btn-primary">上一步</a>
		...
		<script>
			function testdb() {
				...
				var url = "<?php echo url('install/Index/testdb'); ?>";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
			...
			$(function() {
				...
				var focus_tips = {
					...
					dbpw : '',
					dbname : '',
					dbprefix : '建议使用默认，同一数据库安装多个YFCMF时需修改',
