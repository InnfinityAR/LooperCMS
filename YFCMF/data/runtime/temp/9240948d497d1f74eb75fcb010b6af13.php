<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\comment\comment_list.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:84:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\comment\ajax_comment_list.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="alldel" name="alldel" method="post" action="<?php echo url('admin/Comment/comment_alldel'); ?>" >
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<tbody id="ajax-data">
									<?php if(is_array($comments) || $comments instanceof \think\Collection || $comments instanceof \think\Paginator): if( count($comments)==0 ) : echo "" ;else: foreach($comments as $key=>$v): ?>
	<tr>
		<td class="hidden-xs" align="center">
			<label class="pos-rel">
				<input name='c_id[]' id="navid" class="ace"  type='checkbox' value='<?php echo $v['c_id']; ?>'>
				<span class="lbl"></span>
			</label>
		</td>
		<td><?php echo $v['c_id']; ?></td>
		<td height="28"><?php echo (isset($v['member_list_username']) && ($v['member_list_username'] !== '')?$v['member_list_username']:$v['member_list_nickname']); ?></td>
		<td class="hidden-sm hidden-xs"><?php echo (isset($v['email']) && ($v['email'] !== '')?$v['email']:$v['member_list_email']); ?></td>
		<td><?php echo $v['c_content']; ?></td>
		<td class="hidden-xs">
			<?php if($v['c_status'] == 1): ?>
				<a class="red state-btn" href="<?php echo url('admin/Comment/comment_state'); ?>" data-id="<?php echo $v['c_id']; ?>" title="已审">
					<div id="zt<?php echo $v['c_id']; ?>"><button class="btn btn-minier btn-yellow">已审</button></div>
				</a>
				<?php else: ?>
				<a class="red state-btn" href="<?php echo url('admin/Comment/comment_state'); ?>" data-id="<?php echo $v['c_id']; ?>" title="未审">
					<div id="zt<?php echo $v['c_id']; ?>"><button class="btn btn-minier btn-danger">未审</button></div>
				</a>
			<?php endif; ?>
		</td>
		<td class="hidden-sm hidden-xs"><?php echo date('Y-m-d H:i:s',$v['createtime']); ?></td>
		<td>
			<div class="action-buttons">
				<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？包括其下子评论" href="<?php echo url('admin/Comment/comment_del',array('c_id'=>$v['c_id'],'p'=>input('p',1))); ?>" title="删除">
