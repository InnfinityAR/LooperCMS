<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:73:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\news\news_back.html";i:1490866247;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1490763674;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:78:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\news\ajax_news_back.html";i:1490852789;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="col-xs-12 col-sm-5">
					...
					<select name="diyflag" class="ajax_change">
						...
						<?php if(is_array($diyflag) || $diyflag instanceof \think\Collection || $diyflag instanceof \think\Paginator): if( count($diyflag)==0 ) : echo "" ;else: foreach($diyflag as $key=>$v): ?>
							<option value="<?php echo $v['diyflag_name']; ?>" <?php if($diyflag_check == $v['diyflag_name']): ?>selected<?php endif; ?>><?php echo $v['diyflag_name']; ?>【<?php echo $v['diyflag_name']; ?>】</option>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<tr>
									...
									<th class="hidden-sm hidden-xs">Loop属性</th>
	...
	<tr>
		...
		<td>
			<div class="action-buttons">
				<a class="red confirm-rst-url-btn" data-info="你确定要还原loop到loop列表吗？" href="<?php echo url('admin/News/news_back_open',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="还原">
					<i class="ace-icon fa fa-check bigger-130"></i>																</a>
				<a class="red confirm-rst-url-btn" data-info="你确定要彻底删除loop吗？" href="<?php echo url('admin/News/news_back_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="删除">
