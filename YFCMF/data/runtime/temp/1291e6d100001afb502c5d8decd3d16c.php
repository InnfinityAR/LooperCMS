<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/\photo_list.html";i:1489327653;s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\head.html";i:1489327653;s:81:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\function.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\config.html";i:1489327653;s:76:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\nav.html";i:1489327653;s:81:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/ajax_photo_list.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\footer.html";i:1489327653;s:80:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\scripts.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12  col-md-12 col-sm-12 col-xs-12 portfolio-wrap" id="news_list">
						<div class="row">
	<div class="portfolio">							
		<?php if(is_array($lists['news']) || $lists['news'] instanceof \think\Collection || $lists['news'] instanceof \think\Paginator): if( count($lists['news'])==0 ) : echo "" ;else: foreach($lists['news'] as $i=>$vo): 
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 item">
				<div class="gallery portfolio-item">
					<?php if(!empty($vo['news_img'])): ?>
						<a href="<?php echo get_imgurl($vo['news_img']); ?>" rel="prettyPhoto[a<?php echo $i; ?>]">
							<span class="portfolio-item-hover"></span>
							<span class="fullscreen"><i class="fa fa-search"></i></span>
							<img src="<?php echo get_imgurl($vo['news_img']); ?>" alt=" "/>
						</a>											
					<?php if(is_array($imgs) || $imgs instanceof \think\Collection || $imgs instanceof \think\Paginator): if( count($imgs)==0 ) : echo "" ;else: foreach($imgs as $k=>$voo): ?>
						<a href="<?php echo get_imgurl($voo); ?>" rel="prettyPhoto[a<?php echo $i; ?>]">
							<img src="<?php echo get_imgurl($voo); ?>" alt=" " style="display:none;"/>
						</a>
					<?php endforeach; endif; else: echo "" ;endif; else: if(is_array($imgs) || $imgs instanceof \think\Collection || $imgs instanceof \think\Paginator): if( count($imgs)==0 ) : echo "" ;else: foreach($imgs as $k=>$voo): ?>
						<a href="<?php echo get_imgurl($voo); ?>" rel="prettyPhoto[a<?php echo $i; ?>]">
							<span class="portfolio-item-hover"></span>
							<span class="fullscreen"><i class="fa fa-search"></i></span>
							<img src="<?php echo get_imgurl($voo); ?>" alt=" " <?php if($k != 0): ?>style="display:none;"<?php endif; ?>/>
						</a>
