<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\sys\storagesys.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="sys" method="post" action="<?php echo url('admin/Sys/runstorage'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否开启云存储： </label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="storage_open" id="storage_open" <?php if(!empty($storage['storage_open'])): ?>checked<?php endif; ?>  value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 	AccessKey： </label>
						<div class="col-sm-9">
							<input type="text" name="accesskey" id="accesskey" value="<?php echo $storage['accesskey']; ?>"  class="col-xs-10 col-sm-7" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="secretkey" id="secretkey" value="<?php echo $storage['secretkey']; ?>"  class="col-xs-10 col-sm-7" required/>
											<span class="help-inline col-xs-12 col-sm-5">
												<span class="middle" id="restwo"></span>
											</span>
						</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 	存储空间(bucket)： </label>
						<div class="col-sm-9">
							<input type="text" name="bucket" id="bucket" value="<?php echo $storage['bucket']; ?>"  class="col-xs-10 col-sm-7" required/>
											<span class="help-inline col-xs-12 col-sm-5">
												<span class="middle" id="restwo"></span>
											</span>
						</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 	访问域名(domain)： </label>
						<div class="col-sm-9">
							<input type="url" name="domain" id="domain" value="<?php echo $storage['domain']; ?>"  class="col-xs-10 col-sm-7" required/>
											<span class="help-inline col-xs-12 col-sm-5">
												<span class="middle" id="restwo">必须以"/"结尾</span>
											</span>
						</div>
					</div>
					<div class="space-4"></div>
