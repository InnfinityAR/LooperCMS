<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/\contact.html";i:1489327653;s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\head.html";i:1489327653;s:81:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\function.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\config.html";i:1489327653;s:76:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\nav.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\footer.html";i:1489327653;s:80:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\scripts.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
...
<head>
    <meta charset="utf-8">
    <title><?php echo lang('contact us'); ?> <?php echo $site_name; ?></title>
...
<div class="section slice no-padding">
    <div id="mapCanvas" class="map-canvas no-margin" style="height: 400px;">
        <script type="text/javascript">
            ...
            var point = new BMap.Point("<?php echo $map_lng; ?>", "<?php echo $map_lat; ?>"); // 创建点坐标
			...
			var sContent =
				"<img style='float:left;margin:4px' id='imgjingu' src='<?php echo $yf_theme_path; ?>public/images/jingu.jpg' width='150' height='100' />" +
				"<p><?php echo lang('phone'); ?>：<?php echo $site_tel; ?></p>" +
				"<p><?php echo lang('homepage'); ?>：http://www.rainfer.cn</p>" +
				"<p><?php echo lang('address'); ?>：<?php echo $site_address; ?></p>";
			var opts = {
				width : 400,     // 信息窗口宽度
				title : "<?php echo lang('our location'); ?>"  // 信息窗口标题
			}
...
<div class="container" style="margin-top:20px;">
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
            <h3 class="title"><?php echo lang('online message'); ?></h3>
            <form class="form-horizontal verify-ajax-form" name="plug_sug_add" id="plug_sug_add" method="post" action="<?php echo url('home/Index/addmsg'); ?>">
                <fieldset>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label><?php echo lang('username'); ?>: <span>*</span></label>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label><?php echo lang('content'); ?>: <span>*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                            ...
                            <img class="verify_img form-control" id="verify_img" src="<?php echo url('home/Index/verify_msg'); ?>" onClick="this.src='<?php echo url('home/Index/verify_msg'); ?>'+'?'+Math.random()" style="cursor:pointer;width:150px;height:48px;padding:0;" title="<?php echo lang('click to get'); ?>">
                        </div>
                    </div>
                </fieldset>
                <div style="height:10px;"></div>
                <button type="submit" class="btn btn-primary" data-wait="1500"><?php echo lang('send message'); ?></button>
                <div class="clearfix"></div>
            </form>
        </div>
        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
            <div class="address widget">
                <h3 class="title"><?php echo lang('contact information'); ?></h3>
                <ul class="contact-us">
                    <li>
                    ...
                    <li>
                        ...
                        <p>
                            <strong><?php echo lang('phone'); ?>:</strong> <?php echo $site_tel; ?>
                        </p>
                    </li>
                    <li>
                        <i class="fa fa-envelope"></i>
                        <p>
                            <strong><?php echo lang('email'); ?>:</strong><a href="mailto:<?php echo $site_admin_email; ?>"><?php echo $site_admin_email; ?></a>
                        </p>
                    </li>
					<li>
						<i class="fa fa-qq"></i>
            ...
            <div class="contact-info widget">
                <h3 class="title"><?php echo lang('working hours'); ?></h3>
                <ul>
                    <li><i class="fa fa-clock-o"> </i><?php echo lang('Monday ~ Friday'); ?>: 9am to 5pm </li>
                    <li><i class="fa fa-clock-o"> </i><?php echo lang('Saturday'); ?>: 9am to 2pm</li>
                    <li><i class="fa fa-times-circle"> </i><?php echo lang('Sunday'); ?>: <?php echo lang('rest'); ?></li>
                </ul>
            </div>
        </div>
    </div>
