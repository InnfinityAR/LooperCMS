<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:78:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\plug\plug_file_list.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:83:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\plug\ajax_plug_file_list.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-3 margintop5">
				<a href="<?php echo url('admin/Plug/plug_file_filter'); ?>">
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/Plug/plug_file_list'); ?>">
				<div class="col-xs-12 col-sm-3 hidden-xs btn-sespan margintop5">
					<div class="input-group">
						<span class="input-group-addon">
							<i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
						</span>
						<input type="text"  name="reservation" id="reservation" class="sl-date form-control " value="<?php echo $sldate; ?>" placeholder="点击选择日期范围" style="height:34px"/>
					</div>
				</div>
				<div class="col-xs-12 col-sm-4 margintop5">
					<div class="input-group">
						...
						<input type="text" name="val" id="val" class="form-control" value="<?php echo $val; ?>" placeholder="输入文件路径" />
				...
				<div class="col-xs-12 col-sm-2 input-group-btn margintop5">
					<a href="<?php echo url('admin/Plug/plug_file_list'); ?>">
			...
			<div class="col-xs-12">
				<div>
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tbody id="ajax-data">
							<?php if(is_array($plug_files) || $plug_files instanceof \think\Collection || $plug_files instanceof \think\Paginator): if( count($plug_files)==0 ) : echo "" ;else: foreach($plug_files as $key=>$v): ?>
	<tr>
		...
		<td>
			<?php 
			 ...
			 if($is_img > 0): ?>
				<img src="__ROOT__<?php echo $v['path']; ?>" style="max-width:40px;max-height:40px;"/>
				<?php else: ?>
				<?php echo $suff; ?>文件
			<?php endif; ?>
		</td>
