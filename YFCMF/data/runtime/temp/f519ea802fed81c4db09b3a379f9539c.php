<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/user\center.html";i:1489327653;s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\head.html";i:1489327653;s:81:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\function.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\config.html";i:1489327653;s:76:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\nav.html";i:1489327653;s:80:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\usernav.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\footer.html";i:1489327653;s:80:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\scripts.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
...
<head>
    <meta charset="utf-8">
    <title><?php echo lang('personal center'); ?> <?php echo $site_name; ?> </title>
...
<div class="wrap">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <h2 class="title"><?php echo lang('personal center'); ?></h2>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <div class="breadcrumbs pull-right">
                            <ul>
                                ...
                                <li><?php echo lang('personal center'); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
	...
	<ul class="category-list slide">
        <a class="list-group-item" href="<?php echo url('home/Center/index'); ?>"> <?php echo lang('center'); ?></a>
		<a class="list-group-item" href="<?php echo url('home/Center/edit'); ?>"> <?php echo lang('modify information'); ?></a>
		<a class="list-group-item" href="<?php echo url('home/Center/password'); ?>"> <?php echo lang('modify pwd'); ?></a>
		<a class="list-group-item" href="<?php echo url('home/Center/bang'); ?>"> <?php echo lang('bind account'); ?></a>
		<a class="list-group-item" href="<?php echo url('home/Center/fav'); ?>"> <?php echo lang('my favorites'); ?></a>
		<a class="list-group-item" href="<?php echo url('home/Comment/index'); ?>"> <?php echo lang('my comments'); ?></a>
	</ul>
</div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <a href="#">
										<span class="profile-picture">
                                            <img src="<?php echo get_imgurl($member_list_headpic,1); ?>" class="headicon" data-toggle="modal" data-target="#myModal" />
										</span>
                                    </a>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <table class="table" style="TABLE-LAYOUT:fixed;WORD-BREAK:break-all">
                                        <tbody>
                                        <tr>
                                            <td style="border:none;width:7em"><?php echo lang('nickname'); ?>:</td>
                                            <td style="border:none;"><?php echo (isset($member_list_nickname) && ($member_list_nickname !== '')?$member_list_nickname:$member_list_username); ?></td>
                                        </tr>
										<tr>
                                            <td style="border:none;width:7em"><?php echo lang('score coin'); ?>:</td>
                                            <td style="border:none;"><?php echo (isset($score) && ($score !== '')?$score:'0'); ?>(<?php echo (isset($coin) && ($coin !== '')?$coin:'0'); ?>)</td>
                                        </tr>
										<tr>
                                            <td style="border:none;width:7em"><?php echo lang('last login'); ?>:</td>
                                            <td style="border:none;"><?php echo date("Y-m-d",$last_login_time); ?>(<?php echo (isset($last_login_ip) && ($last_login_ip !== '')?$last_login_ip:""); ?>)</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;width:7em"><?php echo lang('sex'); ?>:</td>
                                            <td style="border:none;"><?php 
                                                $sexs=array("1"=>lang('ProMonkey'),"2"=>lang('ProMM'),"3"=>lang('secrecy'));
                                             ?>
                                                <?php echo $sexs[$member_list_sex]; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;width:7em"><?php echo lang('phone'); ?>:</td>
                                            <td style="border:none;"><?php echo (isset($member_list_tel) && ($member_list_tel !== '')?$member_list_tel:""); ?></td>
                                        </tr>
										<tr>
                                            <td style="border:none;width:7em"><?php echo lang('personal website'); ?>:</td>
                                            <td style="border:none;"><?php echo (isset($user_url) && ($user_url !== '')?$user_url:""); ?></td>
                                        </tr>
										<tr>
                                            <td style="border:none;width:7em"><?php echo lang('signature'); ?>:</td>
                                            <td style="border:none;"><?php echo (isset($signature) && ($signature !== '')?$signature:""); ?></td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;width:7em"><?php echo lang('address'); ?>:</td>
                                            <td style="border:none;"><?php echo (isset($address) && ($address !== '')?$address:""); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <div>
                                        <a href="<?php echo url('home/Center/edit'); ?>" type="submit" class="btn btn-primary js-ajax-submit  col-lg-3 col-md-3 col-sm-3 col-xs-3"><?php echo lang('edit'); ?></a>
...
<script type="text/javascript">
	var SHEAR = {
        ...
        <!-- 显示模态框（Modal） -->
        <div class="modal fade modal-avatar" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="width:60%;">
                <div class="modal-content"  style="min-width:620px;">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">
                            <?php echo lang('member avatar'); ?>
                        </h4>
                    </div>
                            ...
                            <div class="col-xs-12">
									...
									<div id="shearphoto_main">
										<div class="Effects" id="shearphoto_Effects" autocomplete="off">
											<strong class="EffectsStrong"><?php echo lang('pic effect'); ?></strong>
											<a href="javascript:;" StrEvent="原图" class="Aclick"><img src="__PUBLIC__/shearphoto/images/Effects/e0.jpg"/><?php echo lang('original'); ?></a>
											<a href="javascript:;" StrEvent="美肤"><img src="__PUBLIC__/shearphoto/images/Effects/e1.jpg"/><?php echo lang('Skin effect'); ?></a>
											<a href="javascript:;" StrEvent="素描"><img src="__PUBLIC__/shearphoto/images/Effects/e2.jpg"/><?php echo lang('Sketch effect'); ?></a>
											<a href="javascript:;" StrEvent="自然增强"><img src="__PUBLIC__/shearphoto/images/Effects/e3.jpg" /><?php echo lang('Enhancement effect'); ?></a>
											<a href="javascript:;" StrEvent="紫调"><img src="__PUBLIC__/shearphoto/images/Effects/e4.jpg" /><?php echo lang('Purple effect'); ?></a>
											<a href="javascript:;" StrEvent="柔焦"><img src="__PUBLIC__/shearphoto/images/Effects/e5.jpg"/><?php echo lang('Soft focus'); ?></a>
											<a href="javascript:;" StrEvent="复古"><img src="__PUBLIC__/shearphoto/images/Effects/e6.jpg"/><?php echo lang('Retro effect'); ?></a>
											<a href="javascript:;" StrEvent="黑白"><img src="__PUBLIC__/shearphoto/images/Effects/e7.jpg"/><?php echo lang('Black-white effect'); ?></a>
											<a href="javascript:;" StrEvent="仿lomo"><img src="__PUBLIC__/shearphoto/images/Effects/e8.jpg"/><?php echo lang('Imitation LOMO'); ?></a>
											<a href="javascript:;" StrEvent="亮白增强"><img src="__PUBLIC__/shearphoto/images/Effects/e9.jpg"/><?php echo lang('Bright white effect'); ?></a>
											<a href="javascript:;" StrEvent="灰白"><img src="__PUBLIC__/shearphoto/images/Effects/e10.jpg"/><?php echo lang('Grey-white effect'); ?></a>
											<a href="javascript:;" StrEvent="灰色"><img src="__PUBLIC__/shearphoto/images/Effects/e11.jpg"/><?php echo lang('Grey effect'); ?></a>
											<a href="javascript:;" StrEvent="暖秋"><img src="__PUBLIC__/shearphoto/images/Effects/e12.jpg"/><?php echo lang('Warm autumn effect'); ?></a>
											<a href="javascript:;" StrEvent="木雕"><img src="__PUBLIC__/shearphoto/images/Effects/e13.jpg"/><?php echo lang('Wood carving effect'); ?></a>
											<a href="javascript:;" StrEvent="粗糙"><img src="__PUBLIC__/shearphoto/images/Effects/e14.jpg"/><?php echo lang('Rough effect'); ?></a>
										</div>
										<div class="primary">
											<div id="main">
												<div class="point"></div>
											...
											<div id="Shearbar">
												<a id="LeftRotate" href="javascript:;"><em></em><?php echo lang('turn L'); ?></a>
												<em class="hint L"></em>
												...
												<em class="hint R"></em>
												<a id="RightRotate" href="javascript:;"><?php echo lang('turn R'); ?><em></em></a>
												<p class="Psava">
													<a id="againIMG"  href="javascript:;"><?php echo lang('reselection'); ?></a>
													<a id="saveShear" href="javascript:;"><?php echo lang('save capture'); ?></a>
												</p>
											</div>
										</div>
										<div style="clear: both"></div>
