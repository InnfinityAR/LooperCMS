<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"E:\wamp\www\rainfer-YFCMF-master\YFCMF\addons\security\view\admin\security_list.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
	<div class="row maintop">
		<div class="col-xs-4 col-sm-3 margintop5">
			<a href="<?php echo addon_url('security://Admin/security_generate'); ?>" id="security_generate">
		...
		<div class="col-xs-12">
			<div>
				<table class="table table-striped table-bordered table-hover" id="dynamic-table">
					...
					<tbody>
					<?php if(is_array($finger_files) || $finger_files instanceof \think\Collection || $finger_files instanceof \think\Paginator): if( count($finger_files)==0 ) : echo "" ;else: foreach($finger_files as $key=>$v): ?>
					<tr>
						...
						<td>
							<div class="action-buttons">
								<a class="red" data-info="检测需要花一点时间，要执行吗？" href="<?php echo addon_url('security://Admin/security_check',array('file'=>md5($v['filename']))); ?>" title="检测">
									<i class="ace-icon fa fa-check bigger-130"></i>
								</a>
								<a class="red confirm-rst-url-btn" data-info="你确定要彻底删除安全文件吗？" href="<?php echo addon_url('security://Admin/security_delete',array('file'=>md5($v['filename']))); ?>" title="删除">
							...
							<div class="hidden-md hidden-lg hidden-sm hidden-xs">
								<div class="inline position-relative">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										<li>
											<a href="<?php echo addon_url('security://Admin/security_check',array('file'=>md5($v['filename']))); ?>" class="tooltip-success confirm-rst-url-btn" data-info="检测需要花一点时间，要执行吗？" data-rel="tooltip" title="" data-original-title="检测">
												<span class="green">
										...
										<li>
											<a href="<?php echo addon_url('security://Admin/security_delete',array('file'=>md5($v['filename']))); ?>"  class="tooltip-error confirm-rst-url-btn" data-info="你确定要彻底删除安全文件吗？" data-rel="tooltip" title="" data-original-title="删除">
												<span class="red">
