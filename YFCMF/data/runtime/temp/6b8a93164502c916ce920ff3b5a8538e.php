<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:54:"E:\wamp\www\YFCMF/app/admin\view\music\music_edit.html";i:1492054826;s:49:"E:\wamp\www\YFCMF/app/admin\view\public\base.html";i:1489327653;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\header.html";i:1491797532;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('admin/Music/music_runedit'); ?>"  enctype="multipart/form-data">
					<input type="hidden" name="n_id" id="n_id" value="<?php echo $news_list['id']; ?>" />
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 音乐名称：  </label>
						<div class="col-sm-10">
							<input type="text" name="news_title" id="news_title"  value="<?php echo $music_list['filename']; ?>"   class="col-xs-10 col-sm-6" required/>
						</div>
					</div>
					<div class="space-4"></div>
					<!--loop风格未改数据库之前-->
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="hidden" name="checkpic" id="checkpic" value="<?php echo $music_cover['path']; ?>" />
							<input type="hidden" name="oldcheckpic" id="oldcheckpic" value="<?php echo $music_cover['path']; ?>" />
							<a href="javascript:;" class="file" title="点击选择所要上传的图片">
								<input type="file" name="pic_one" id="file0" multiple="multiple"/>
								选择上传文件
							</a>
							<span class="lbl">&nbsp;&nbsp;<img src='<?php if($music_cover['path'] != 1): ?><?php echo get_imgurl($music_cover['path']); else: ?><?php echo $music_cover['path']; endif; ?>' width="100" height="70" id="img0" ></span>&nbsp;&nbsp;<a href="javascript:;" onclick="return backpic('<?php if($music_cover['path'] != 1): ?><?php echo get_imgurl($music_cover['path']); else: ?><?php echo $music_cover['path']; endif; ?>');" title="还原修改前的图片" class="file">
							撤销修改
							</a>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="radio" >
								<label>
									<input name="news_pic_type" <?php if($music_list['path'] == ''): ?>checked<?php endif; ?> id="news_pic_list" checked type="radio" class="ace" value="1"/>
									<span class="lbl"> 无图模式</span>
								</label>
								<label>
									<input name="news_pic_type" <?php if($music_list['path']): ?>checked<?php endif; ?> id="news_pic_qqlist" type="radio" class="ace" value="2"/>
									<span class="lbl"> 多图模式</span>
								</label>
								<?php if($music_list['path']): ?>
								<label>
						...
						<div class="form-group" id="pic_list" <?php if($music_list == ''): ?>style="display:none"<?php endif; ?>>
