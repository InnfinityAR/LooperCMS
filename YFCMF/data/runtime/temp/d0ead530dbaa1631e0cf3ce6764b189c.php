<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\news\news_edit.html";i:1490956699;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1490763674;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('admin/News/news_runedit'); ?>"  enctype="multipart/form-data">
					...
					<div class="form-group" id="pic_list" <?php if($news_list['news_pic_type'] == 1): ?>style="display:none"<?php endif; ?>>
						<div class="col-sm-10 col-sm-offset-2" style="padding-top:5px;">
							...
							<textarea name="news_pic_content" class="col-xs-12 col-sm-12" id="news_pic_content"  placeholder="单次编辑或添加Loop,选择多图时请一次性选择。多图对应Loop说明，例如： 图片一说明 | 图片二说明 | 图片三说明    每个文字说明以 | 分割" ><?php echo $news_list['news_pic_content']; ?></textarea>
						</div>
					</div>
					<div class="space-4"></div>
					<!--老多图字符串-->
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<span class="lbl">&nbsp;&nbsp;默认为Loop添加日期</span>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="news_scontent" id="news_scontent" class="col-xs-10 col-sm-10"  maxlength="100" value="<?php echo $news_list['news_scontent']; ?>"  placeholder="输入Loop简介"  />
