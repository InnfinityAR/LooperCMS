<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/\about.html";i:1489327653;s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\head.html";i:1489327653;s:81:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\function.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\config.html";i:1489327653;s:76:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\nav.html";i:1489327653;s:79:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\footer.html";i:1489327653;s:80:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/home/view/default/public\scripts.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
...
<!-- 	<?php $test=get_data("faq","","","","","","","","","true","10","","2");?> -->
<!-- 	<?php dump($test); ?> -->
    <div id="main-cmf">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <h2 class="title"><?php echo lang('about us'); ?></h2>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="posts-block col-lg-8 col-md-8 col-sm-6 col-xs-12">
                        <article>
							<?php $menu=get_menu_one("$about_id");?>
                            <h3 class="title"><?php echo lang('team introduction'); ?></h3>
                            <div class="post-content">
                                <div class="img-content">
                                    <img src="<?php echo get_imgurl($menu['menu_img']); ?>" alt="" style="max-width:350px">
                                </div>
                                <p><?php echo $menu['menu_content']; ?></p>
                            </div>
                        </article>
                    </div>
                    <div class="skills col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <h3 class="title"><?php echo lang('our advantage'); ?></h3>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 85%;"><?php echo lang('our advantage one'); ?> 90%</div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 65%;"><?php echo lang('our advantage two'); ?> 85%</div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"><?php echo lang('our advantage three'); ?> 90%</div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"><?php echo lang('our advantage four'); ?> 90%</div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%;"><?php echo lang('our advantage five'); ?> 75%</div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h3 class="title"><?php echo lang('work flow'); ?></h3>
                        <div class="widget tabs animate_afc">
                            <div id="horizontal-tabs">
                                <ul class="tabs">
                                    <li id="tab1" class="current"><?php echo lang('design'); ?></li>
                                    <li id="tab2"><?php echo lang('development phase'); ?></li>
                                    <li id="tab3"><?php echo lang('test and acceptance'); ?></li>
                                </ul>
                                <div class="contents">
                                    <div class="tabscontent" id="content1" style="display: block;">
                                        <p><?php echo lang('flow one'); ?>
                                        </p>
                                    </div>
                                    <div class="tabscontent" id="content2">
                                        <p><?php echo lang('flow two'); ?>
                                        </p>
                                    </div>
                                    <div class="tabscontent" id="content3">
                                        <p><?php echo lang('flow three'); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="testimonials widget">
                                ...
                                <div id="testimonials-carousel" class="testimonials-carousel slide animate_afc">
                                    <div class="carousel-inner">
										<?php $positive=get_news("cid:$positive_cid;field:news_title,news_scontent,news_source,n_id,news_img;limit:8;order:news_time desc",false,10,"null","");if(is_array($positive) || $positive instanceof \think\Collection || $positive instanceof \think\Paginator): if( count($positive)==0 ) : echo "" ;else: foreach($positive as $k=>$vo): ?>
                                                ...
                                                <div class="testimonial item">
                                                    ...
                                                    <div class="author">
                                                        ...
                                                        <div class="testimonial-author-info">
                                                            <a href=""><span class="color"><?php echo $vo['news_title']; ?></span></a><?php echo $vo['news_source']; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
