<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:77:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\music\albumid_list.html";i:1490862682;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1490763674;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:78:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\news\ajax_news_list.html";i:1490932517;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
				...
				<div class="col-xs-12 col-sm-12 maintop">
					...
					<select name="diyflag" class="ajax_change">
						...
						<?php if(is_array($diyflag) || $diyflag instanceof \think\Collection || $diyflag instanceof \think\Paginator): if( count($diyflag)==0 ) : echo "" ;else: foreach($diyflag as $key=>$v): ?>
							<option value="<?php echo $v['diyflag_name']; ?>" ><?php echo $v['diyflag_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
	...
	<tr>
		...
		<!--<td class="hidden-xs hidden-sm">-->
			...
			<!--<?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $key=>$vo): ?>-->
				<!--<?php if(($vo['menu_type'] != '') AND ($vo['menu_l'] == $v['news_l'])): ?>-->
