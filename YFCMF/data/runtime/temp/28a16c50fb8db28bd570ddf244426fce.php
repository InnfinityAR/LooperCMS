<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\sys\smssys.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="smssys" method="post" action="<?php echo url('admin/Sys/runsmssys'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> AccessKeyId： </label>
						<div class="col-sm-9">
							<input type="text" name="AccessKeyId" id="qq_appid" value="<?php echo $sms_sys['AccessKeyId']; ?>"  placeholder="请输入AccessKeyId"  class="col-xs-10 col-sm-5" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="accessKeySecret" id="password" value="<?php echo $sms_sys['accessKeySecret']; ?>" placeholder="accessKeySecret"   class="col-xs-10 col-sm-5" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="TemplateCode" id="signName" value="<?php echo $sms_sys['TemplateCode']; ?>" placeholder="TemplateCode"   class="col-xs-10 col-sm-5" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>短信模板的模板CODE</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="restwo"></span>
											</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="signName" id="signName" value="<?php echo $sms_sys['signName']; ?>" placeholder="signName"   class="col-xs-10 col-sm-5" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>管理控制台中配置的短信签名（状态必须是验证通过）</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="restwo"></span>
											</span>
						</div>
					...
					<div class="form-group">
                                    ...
                                    <input name="sms_open" id="sms_open" <?php if($sms_sys['sms_open'] == 1): ?>checked<?php endif; ?> value="1" class="ace ace-switch ace-switch-4 btn-flat col-xs-10 col-sm-5" type="checkbox" /> 
