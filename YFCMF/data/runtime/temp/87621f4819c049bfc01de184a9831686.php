<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\news\news_add.html";i:1491031555;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1490763674;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('admin/News/news_runadd'); ?>"  enctype="multipart/form-data">
					...
					<div class="form-group" >
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Loop所属主栏目： </label>
						<div class="col-sm-10">
							<select name="news_columnid"  class="col-sm-3 selector" required>
								<option value="">请选择歌单栏目</option>
					...
					<div class="form-group">
						...
						<div class="checkbox" >
							...
							<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="float: right; overflow:hidden; ">
								自定义风格
							</button>
							<!-- 模态框（Modal） -->
					...
					<div class="form-group" id="pic_list">
						<div class="col-sm-10 col-sm-offset-2" style="padding-top:5px;">
							...
							<textarea name="news_pic_content" class="col-xs-12 col-sm-12" id="news_pic_content"  placeholder="单次编辑或添加Loop,选择多图时请一次性选择。多图对应Loop说明，例如： 图片一说明 | 图片二说明 | 图片三说明    每个文字说明以 | 分割" ></textarea>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input name="showdate" class="date-picker col-xs-10 col-sm-6" value="<?php $time = time();echo date('Y-m-d',$time) ?>" type="text" data-date-format="yyyy-mm-dd">
						</div>
					</div>
					<div class="space-4"></div>
					<!--//loop简介：-->
