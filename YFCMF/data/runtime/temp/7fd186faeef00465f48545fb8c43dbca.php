<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\sys\export.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1490763674;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="page-content">
        ...
        <div class="row maintop">
            <div class="col-xs-12 col-sm-8">
                ...
                <a id="optimize" href="<?php echo url('admin/Sys/optimize'); ?>">
                    <button class="btn btn-xs btn-danger">
                        <i class="ace-icon fa fa-check-circle bigger-110"></i>
                        优化数据表
                    </button>
                </a>
                <a id="repair"  href="<?php echo url('admin/Sys/repair'); ?>">
                    <button class="btn btn-xs btn-danger">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons" >
                                            <a class="green" href="<?php echo url('admin/Sys/optimize?tables='.$v['name']); ?>" id="optimize_<?php echo $v['name']; ?>" title="优化表">
                                                <i class="ace-icon fa fa-check-circle bigger-130"></i>
                                            </a>
                                            <a class="info" href="<?php echo url('admin/Sys/repair?tables='.$v['name']); ?>" id="repair_<?php echo $v['name']; ?>" title="修复表">
                                                <i class="ace-icon fa fa-check-square-o bigger-130"></i>
                                            </a>
                                            <a class="info backup" href="<?php echo url('admin/Sys/exportsql?table='.$v['name']); ?>" title="备份表">
