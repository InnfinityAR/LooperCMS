<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:54:"E:\wamp\www\YFCMF/app/admin\view\music\music_list.html";i:1491990343;s:49:"E:\wamp\www\YFCMF/app/admin\view\public\base.html";i:1489327653;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\header.html";i:1491797532;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:59:"E:\wamp\www\YFCMF/app/admin\view\music\ajax_music_list.html";i:1491991180;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<tr>
									...
									<th>音乐标题</th>
									<th class="hidden-sm hidden-xs">音乐风格</th>
									<th class="hidden-xs">艺人</th>
									<th style="border-right:#CCC solid 1px;">年份</th>
									<th class="hidden-xs">所属专辑</th>
									<th style="border-right:#CCC solid 1px;">上传时间</th>
	...
	<tr>
		...
		<label class="pos-rel">
			<input name='musicid' id="navid" class="ace"  type='checkbox' value='<?php echo $v['id']; ?>'>
			<span class="lbl"></span>
		</label>
	</td>
		<td class="hidden-xs center" style="width: 250px;"><?php echo $v['filename']; ?></td>
		<!--loop风格-->
		<td class="hidden-sm hidden-xs">
			<span style="color:#03C"><?php echo $v['news_flag']; ?></span>
			</td>
		<td class="hidden-xs"><?php echo $v['artist']; ?></td>
		<td class="hidden-xs"><?php echo $v['year']; ?></td>
		<td class="hidden-xs"><?php echo $v['albumnname']; ?></td>
		<td class="hidden-xs"><?php echo $v['creationdate']; ?></td>
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<a class="green" href="<?php echo url('admin/Music/music_edit',array('id'=>$v['id'])); ?>" data-toggle="tooltip" title="修改">
					<i class="ace-icon fa fa-pencil bigger-130"></i>
				</a>
				<a class="red confirm-rst-url-btn" data-info="你确定要删除到回收站吗？" href="<?php echo url('admin/Music/music_del',array('id'=>$v['id'],'p'=>input('p',1))); ?>" title="回收站" data-toggle="tooltip">
			...
			<div class="hidden-md hidden-lg">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('admin/Music/music_edit',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
											<span class="green">
						...
						<li>
						<a href="<?php echo url('admin/Music/music_del',array('id'=>$v['id'],'p'=>input('p',1))); ?>" data-info="你确定要删除到回收站吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="回收站" data-original-title="回收站">
							<span class="red">
...
<tr>
	...
	<td align="left" class="hidden-xs center"><button  id="btnorder" href="<?php echo url('admin/Music/music_order'); ?>" class="btn btn-white btn-yellow btn-sm">排序</button></td>
