<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\web_log\weblog_setting.html";i:1489327653;s:70:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\base.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\header.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\left_nav.html";i:1489327653;s:74:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\head_nav.html";i:1489327653;s:72:"E:\wamp\www\rainfer-YFCMF-master\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<link rel="stylesheet" href="__PUBLIC__/bootstrap-select/css/bootstrap-select.min.css">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="urlsys" method="post" action="<?php echo url('admin/WebLog/weblog_runset'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否开启操作日志：</label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="weblog_on" id="weblog_on" <?php if($web_log['weblog_on']): ?>checked<?php endif; ?> value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>					
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<?php if(is_array($modules) || $modules instanceof \think\Collection || $modules instanceof \think\Paginator): if( count($modules)==0 ) : echo "" ;else: foreach($modules as $key=>$vo): ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<optgroup label="<?php echo $v; ?>模块">
							<?php if(!(empty($controllers[$v]) || (($controllers[$v] instanceof \think\Collection || $controllers[$v] instanceof \think\Paginator ) && $controllers[$v]->isEmpty()))): if(is_array($controllers[$v]) || $controllers[$v] instanceof \think\Collection || $controllers[$v] instanceof \think\Paginator): if( count($controllers[$v])==0 ) : echo "" ;else: foreach($controllers[$v] as $key=>$vv): ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<?php if(is_array($actions) || $actions instanceof \think\Collection || $actions instanceof \think\Paginator): if( count($actions)==0 ) : echo "" ;else: foreach($actions as $k=>$v): ?>
							<optgroup label="<?php echo $k; ?>">
							<?php if(is_array($v) || $v instanceof \think\Collection || $v instanceof \think\Paginator): if( count($v)==0 ) : echo "" ;else: foreach($v as $key=>$vv): ?>
							<option><?php echo $k; ?>/<?php echo $vv; ?></option>
							<?php endforeach; endif; else: echo "" ;endif; ?>
							</optgroup>
							<?php endforeach; endif; else: echo "" ;endif; ?>						
							</select>
...
<script>
$('#selectmodule').selectpicker('val',"<?php echo $web_log['not_log_module']; ?>".split(','));
$('#selectcontroller').selectpicker('val',"<?php echo $web_log['not_log_controller']; ?>".split(','));
$('#selectaction').selectpicker('val',"<?php echo $web_log['not_log_action']; ?>".split(','));
$('#selectdata').selectpicker('val',"<?php echo $web_log['not_log_data']; ?>".split(','));
$('#selectmethod').selectpicker('val',"<?php echo $web_log['not_log_request_method']; ?>".split(','));
</script>
