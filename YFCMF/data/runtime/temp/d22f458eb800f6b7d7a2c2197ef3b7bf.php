<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:53:"E:\wamp\www\YFCMF/app/admin\view\music\music_add.html";i:1491619157;s:49:"E:\wamp\www\YFCMF/app/admin\view\public\base.html";i:1489327653;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\header.html";i:1491797532;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\left_nav.html";i:1490771066;s:53:"E:\wamp\www\YFCMF/app/admin\view\public\head_nav.html";i:1490763638;s:51:"E:\wamp\www\YFCMF/app/admin\view\public\footer.html";i:1489327653;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('admin/Music/albumn_runadd'); ?>"  enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 专辑名称：  </label>
						<div class="col-sm-10">
							<input type="text" name="news_title" id="news_title"  placeholder="必填：专辑名称"  class="col-xs-10 col-sm-6" required/>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 专辑风格：  </label>
						<div class="checkbox">
					...
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 专辑封面上传： </label>
						<div class="col-sm-10">
							<a href="javascript:;" class="file">
								<input type="file" name="pic_one" id="file0" />
								选择上传文件
							</a>
							<span class="lbl">&nbsp;&nbsp;<img src="__PUBLIC__/img/no_img.jpg" width="100" height="70" id="img0" ></span>&nbsp;&nbsp;
					...
					<div class="form-group" id="pic_list">
						<div class="col-sm-10 col-sm-offset-2" style="padding-top:5px;">
							...
							<textarea name="news_pic_content" class="col-xs-12 col-sm-12" id="news_pic_content"  placeholder="单次编辑或添加专辑时上传音乐" ></textarea>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
